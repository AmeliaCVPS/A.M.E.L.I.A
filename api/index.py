...
try:
    ...
    from API.database import init_db, save_prontuario, load_prontuario
    from API.ml_model  import predict_risk, SymptomsInput
    from API.nlp_pipeline import triage_text, symptoms_to_human
