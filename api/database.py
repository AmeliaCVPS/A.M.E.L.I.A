...
def _init_cipher() -> Fernet:
    ...
    key_dir = tempfile.gettempdir() if IS_SERVERLESS else root
    key_name = "amelia_secret.key" if IS_SERVERLESS else "secret.key"
...
SQLITE_PATH = os.path.join(
    tempfile.gettempdir() if IS_SERVERLESS else _ROOT,
    "amelia_local.db",
)
